...
plot 'bitratestats_others.gnudata' using ($2/1024):xtic(1) title "DC-net bitrate" linecolor rgb "#0000FF", \
    'bitratestats_others.gnudata' using (3*$2/1024):xtic(1) fs pattern 2 title "Servers->Relay bitrate" linecolor rgb "#FF0000"
