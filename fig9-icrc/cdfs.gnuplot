...
set style line 1 linecolor rgb '#0000FF' linetype 1 linewidth 1
...
set output 'cdfNumberOfUsersPerSites.pdf'

set title "CDF of number of users per site"
set xlabel "Number of users" offset 0,0.5
set ylabel "Percentage of Sites [%]" offset 1.7,0

plot 'cdfNumberOfUsersPerSites.txt' using 1:2 notitle with linespoints ls 1
