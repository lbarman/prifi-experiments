...
set title "Disruption Protection - Blame duration"
...
plot 'blame-duration.gnudata' using 1:2:3 notitle with lp ls 1, \
    'blame-duration.gnudata' using 1:2:3 notitle with errorbar ls 1 lw 1
